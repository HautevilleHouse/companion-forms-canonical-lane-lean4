# Companion Forms — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/companion-forms-canonical-lane-mathlib.git
cd companion-forms-canonical-lane-mathlib
lake exe
lake build
```
